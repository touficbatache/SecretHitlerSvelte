...
{#if $gameData?.players}
  <div class="w-full flex flex-col items-center gap-32 px-6 md:p-0">
    ...
    <div class="flex">
      <div
        class="z-30 rounded-md h-48 aspect-[397/555] bg-contain bg-center -rotate-[15deg] -ml-2.5 -mt-1"
      ...
      />
      <div
        class="z-20 rounded-md h-48 aspect-[397/555] bg-contain bg-center rotate-[15deg] -ml-2 -mt-1"
